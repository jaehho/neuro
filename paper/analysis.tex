...
\begin{align}
    ...
    \tau_{\bar{R}} \frac{d\bar{R}}{dt} &= -\bar{R} - \bigl(r_{\mathrm{post}} - \tfrac{1}{2}\, r_{\mathrm{pre}}\bigr)^2, \label{eq:ref_Rbar} \\[6pt]
    \frac{dw}{dt} &= \Bigl[-\bigl(r_{\mathrm{post}} - \tfrac{1}{2}\, r_{\mathrm{pre}}\bigr)^2 - \bar{R}\Bigr]\, E. \label{eq:ref_w}
\end{align}
...
$\tau_{\bar{R}}$       & Running reward average          & 1--10\,s                &
  \cite{gerstnerEligibilityTracesPlasticity2018,fremauxNeuromodulatedSpikeTimingDependentPlasticity2016,Sutton1998} \\[6pt]

...
The stepper below is character-for-character identical to the RK4 branch
in src/neuro/sim.py ``_advance_state`` (lines 527-531), extracted to
accept any autonomous RHS  f(y) → dy/dt.
...
Run:  uv run python scripts/test_rk4_nonlinear.py
"""
